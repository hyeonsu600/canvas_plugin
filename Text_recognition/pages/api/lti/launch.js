...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (!id_token) {
      console.warn('⚠️ Text_recognition Dev fallback: no id_token, skipping validation');
      return res.redirect('/');
    }

    console.log("Text_recognition LTI launch request received! Verifying token...");
    ...
    console.error("Text_recognition LTI Launch Error:", error);
