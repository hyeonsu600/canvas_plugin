...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log('🔧 PDF_Log Canvas LMS URL:', canvasLmsUrl);
    ...
    console.log("PDF_Log LTI launch request received! Verifying token...");
    ...
    console.error("PDF_Log LTI Launch Error:", error);
